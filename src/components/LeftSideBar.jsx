...
const LeftSideBar = () => {
  ...
  return (
    <div className={`${toggleSideBar && 'hidden'} lg:block bg-slate-100 w-72 h-full  absolute left-0 top-0`}> 
        ...
        {(() => {
            switch(pathname) {
                case '/friends' :
                    return <div className='lg:hidden'><FriendsSideBar/></div>
                case '/' :
                    return <div className='lg:hidden'><RightSideBar/></div>
                default :
                    return null
            }
        } 
