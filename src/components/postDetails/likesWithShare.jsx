    ...
    return (
        <>
            <div className="flex justify-between py-px">
                ...
                <span>{post?.like?.likes ?? 0}</span>
                </div>
                <div className="text-zinc-900 text-sm font-medium">{post?.commentsCount} comments<span className="ml-3 text-zinc-900">{shares ? shares : 0} {shares === 1 ? 'share' : 'shares'} </span></div>
            </div>
            {/*line */}
            <div className="border-t opacity-20 border-black "></div>

            <div className="flex justify-around py-px">
            <button onClick={addLike} className="text-zinc-900 font-semibold"><span className="mr-2 opacity-90"><ThumbUpIcon sx={{fontSize:20}}/></span>like</button>
            <div className="text-zinc-900 font-semibold"><span className="mr-2 opacity-70"><ChatBubbleOutlineOutlinedIcon sx={{fontSize:20}}/></span>comment</div>
            <div className="text-zinc-900 font-semibold"><span className="mr-2 opacity-70"><ShareIcon sx={{fontSize:20}}/></span>share</div>
            </div>
